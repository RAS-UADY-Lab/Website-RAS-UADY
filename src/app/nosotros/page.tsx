              ...
              <Card className="group card-brand ring-0 transition-all duration-300 hover:-translate-y-1 bg-white p-2">
                ...
                <CardContent>
                  <p className="pb-8 text-neutral-600 leading-relaxed">
                    ...
                    estudiantes de la Facultad de Ingeniería de la UADY,
                    mediante actividades formativas, colaborativas y de
                    divulgación en el área de robótica y automatización,
                    fomentando el liderazgo, la innovación y la vinculación con
                    la comunidad global de IEEE - RAS.
                  </p>
                </CardContent>
              </Card>
            </Reveal>
              ...
              <Card className="group card-brand ring-0 transition-all duration-300 hover:-translate-y-1 bg-white p-2">
                ...
                <CardContent>
                  <p className="pb-8 text-neutral-600 leading-relaxed">
                    ...
                    tecnología como motor de cambio, conectando a estudiantes
                    con oportunidades reales de impacto en el ámbito académico,
        ...
        <div className="container mx-auto max-w-7xl px-4 md:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {isLoading ? (
              ...
              mesaActual.map((dir) => (
                <Reveal key={dir.id} delay={0}>
                  <Card className="group card-brand ring-0 flex flex-col h-full transition-all duration-300 hover:shadow-md hover:shadow-neutral-900/10 hover:-translate-y-1 cursor-default">
