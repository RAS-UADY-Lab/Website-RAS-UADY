          ...
          <Reveal delay={0}>
            <div className="mb-16 text-center max-w-3xl mx-auto">
              ...
              <p className="mt-4 text-lg text-neutral-600">
                ¿Nuevo en la facultad? Descubre qué es IEEE, cómo funciona
                nuestra sociedad técnica y por qué unirte es el mejor impulso
                para tu carrera en ingeniería.
              </p>
            </div>
          </Reveal>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <Card className="group card-brand ring-0 flex flex-col h-full bg-white transition-all duration-300 hover:-translate-y-1">
                ...
                <CardContent className="flex-1">
                  <p className="text-sm text-neutral-600 leading-relaxed">
                    ...
                    (Institute of Electrical and Electronics Engineers). Su
                    misión es fomentar la innovación tecnológica en beneficio de
                    la humanidad. Establecen estándares globales (como el Wi-Fi)
                    y publican la mayor parte de la literatura técnica del
                    mundo.
                  </p>
                </CardContent>
              ...
              <Card className="group card-brand ring-0 flex flex-col h-full bg-white transition-all duration-300 hover:-translate-y-1">
                ...
                <CardContent className="flex-1">
                  <p className="text-sm text-neutral-600 leading-relaxed">
                    ...
                    especializadas. <strong>RAS</strong> (Robotics and
                    Automation Society) es la rama enfocada exclusivamente en la
                    teoría y práctica de la robótica, sistemas de control, IA
                    aplicada y automatización industrial.
                  </p>
                </CardContent>
                <div className="p-6 pt-0 mt-auto">
                  <Link
            ...
            <Reveal delay={0}>
              <Card className="group card-brand ring-0 flex flex-col h-full bg-white transition-all duration-300 hover:-translate-y-1">
                ...
                <CardContent className="flex-1">
                  <p className="text-sm text-neutral-600 leading-relaxed">
                    Un <strong>Capítulo Estudiantil</strong> es la
                    representación oficial de una Sociedad de IEEE dentro de una
                    universidad. Nosotros somos el puente que conecta a los
                    estudiantes de la FIUADY con los recursos, competencias y el
                    respaldo internacional de IEEE RAS.
                  </p>
                </CardContent>
                <div className="p-6 pt-0 mt-auto">
                  <Link
              ...
              <Reveal delay={0}>
                <details className="group border border-neutral-200 bg-white rounded-xl overflow-hidden [&_summary::-webkit-details-marker]:hidden shadow-sm">
                  ...
                  <div className="p-5 pt-0 text-sm text-neutral-600 leading-relaxed border-t border-neutral-100 mt-2 bg-slate-50/50">
                    ...
                    oportunidad de desarrollar habilidades blandas y de
                    liderazgo. Es el diferenciador perfecto en tu currículum al
                    graduarte frente a otros ingenieros.
                  </div>
                </details>
              </Reveal>
              ...
              <Reveal delay={0}>
                <details className="group border border-neutral-200 bg-white rounded-xl overflow-hidden [&_summary::-webkit-details-marker]:hidden shadow-sm">
                  ...
                  <div className="p-5 pt-0 text-sm text-neutral-600 leading-relaxed border-t border-neutral-100 mt-2 bg-slate-50/50">
                    ...
                    nuestros eventos y decides cuándo participar en ellos. Como{" "}
                    <strong>miembro formal o staff</strong>, te comprometes a
                    apoyar en la logística de eventos, aportar ideas para
                    proyectos técnicos y asistir a las reuniones cuando tu
                    horario de clases te lo permita.
                  </div>
                </details>
              </Reveal>
              ...
              <Reveal delay={0}>
                <details className="group border border-neutral-200 bg-white rounded-xl overflow-hidden [&_summary::-webkit-details-marker]:hidden shadow-sm">
                  ...
                  <div className="p-5 pt-0 text-sm text-neutral-600 leading-relaxed border-t border-neutral-100 mt-2 bg-slate-50/50">
                    ...
                    las ingenierías (Mecatrónica, Software, Energías, Civil,
                    etc.) desde su primer semestre. Si tienes las ganas de
                    aprender, nosotros te proporcionamos los espacios, talleres
                    y compañeros para hacerlo.
                  </div>
                </details>
              </Reveal>
              ...
              <Reveal delay={0}>
                <details className="group border border-neutral-200 bg-white rounded-xl overflow-hidden [&_summary::-webkit-details-marker]:hidden shadow-sm">
                  ...
                  <div className="p-5 pt-0 text-sm text-neutral-600 leading-relaxed border-t border-neutral-100 mt-2 bg-slate-50/50">
                    ...
                    <strong>Membresía Anual IEEE Estudiantil</strong> y la{" "}
                    <strong> Membresía Anual IEEE RAS Estudiantil</strong>, las
                    cuales se pagan directamente en la plataforma global de
                    IEEE.
                  </div>
                </details>
              </Reveal>
            ...
            <div className="container mx-auto max-w-7xl px-4 md:px-8">
              <div className="flex flex-col lg:flex-row items-center gap-12 bg-slate-50 border border-neutral-200 rounded-3xl p-8 lg:p-12 shadow-sm relative overflow-hidden">
                ...
                <div className="w-full lg:w-1/2 flex flex-col items-start text-left z-10 mt-4 lg:mt-0">
                  ...
                  <p className="text-base text-neutral-400 capitalize tracking-widest mb-6">
      ...
      <section className="bg-slate-50 py-20">
        <div className="container mx-auto max-w-7xl px-4 md:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Reveal delay={0}>
              <Card className="group card-brand ring-0 transition-all duration-300 hover:-translate-y-1 h-full">
          ...
          <Reveal delay={0}>
            <div className="mb-12 text-center max-w-3xl mx-auto">
              ...
              <p className="mt-4 text-neutral-600">
                ...
                asistir como oyente, hasta involucrarte como voluntario o staff.
                Explora las oportunidades y aprovecha la que mejor se adapte a
                ti.
              </p>
            </div>
          </Reveal>
              ...
              <Card className="group card-brand ring-0 flex flex-col h-full transition-all duration-300 hover:-translate-y-1">
                ...
                <CardContent className="flex-1">
                  <CardDescription className="text-sm text-neutral-600">
                    ...
                    internacionales. Aprovecha sus recursos técnicos,
                    competencias globales y descuentos.
                  </CardDescription>
                </CardContent>
                <div className="p-6 pt-0 mt-auto">
                  <Link
