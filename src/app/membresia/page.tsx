        ...
        <div className="container mx-auto max-w-4xl px-4 md:px-8 text-center">
          ...
          <Reveal delay={0}>
            <p className="text-lg md:text-xl text-neutral-600 leading-relaxed mb-10 text-pretty mx-auto max-w-3xl">
              ...
              exclusivamente en la vanguardia de la robótica y la
              automatización.
            </p>
          </Reveal>
            ...
            <Reveal delay={0}>
              <div className="flex flex-col md:flex-row-reverse gap-10 md:gap-16 items-center">
                ...
                <div className="w-full md:w-1/2 space-y-4 text-left">
                  ...
                  <p className="text-neutral-600 leading-relaxed text-lg text-pretty">
                    Gana el derecho de representar al Capítulo Estudiantil
                    FIUADY en competencias internacionales como el{" "}
                    <em>IEEE Robotics Competition</em>, <em>RAS Challenges</em>{" "}
                    o <em>IEEEXtreme</em>. Además, tu membresía te habilita para
                    solicitar fondos institucionales y becas de financiamiento
              ...
              <div className="flex flex-col md:flex-row gap-10 md:gap-16 items-center">
                ...
                <div className="w-full md:w-1/2 space-y-4 text-left">
                  ...
                  <p className="text-neutral-600 leading-relaxed text-lg text-pretty">
                    ...
                    en todo el mundo a través de conferencias exclusivas,
                    talleres prácticos y seminarios web organizados por la
                    directiva global de IEEE - RAS.
                  </p>
                </div>
              </div>
            </Reveal>
              ...
              <div className="flex flex-col md:flex-row gap-10 md:gap-16 items-center">
                ...
                <div className="w-full md:w-1/2 space-y-4 text-left">
                  ...
                  <p className="text-neutral-600 leading-relaxed text-lg text-pretty">
                    ...
                    económicas. Disfruta de tarifas reducidas en
                    certificaciones, conferencias, hardware y licencias de
                    software, junto con apoyos económicos reservados
                    exclusivamente para miembros estudiantiles activos.
                  </p>
                </div>
              </div>
            </Reveal>
        ...
        <div className="container mx-auto max-w-4xl px-4 md:px-8 text-center">
          ...
          <Reveal delay={0}>
            <p className="text-neutral-600 mb-10 text-pretty mx-auto max-w-2xl">
              Visita el portal global para explorar todos los recursos
              disponibles o comunícate con la directiva local para guiarte paso
              a paso.
            </p>
          </Reveal>
          <Reveal delay={0}>
